...
CREATE TABLE IF NOT EXISTS `auth_roles` (
  ...
  `routes` varchar(4000) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '该角色拥有的前端路由地址集合',
  `menus` varchar(4000) NOT NULL DEFAULT '[{"name":"欢迎页","type":"route","path":"\/welcome","parent":"根菜单","selected":true}]' COMMENT '该角色拥有的左侧菜单树的菜单树(json字符串)',
