...

    {
        path: '/', component: Dashboard,children:[
            ...
            },
            {
                ...
                meta: {
                    guarded: false,
                    canBeSetAsMenu: false,
                    description: '函数型组件，禁止作为左侧菜单'
                }
            },
            {
                path: '/example/plain',
                component: PlainExample,
                name:'文字示例',
                meta: {
                    guarded: false ,
                    canBeSetAsMenu: true
            ...
            },
            {
                ...
                meta: {
                    guarded: true ,
                    canBeSetAsMenu: true ,
                    description: '系统菜单设置,角色菜单是系统菜单的子集'
                }
            },
            {
                path: '/order/list',
